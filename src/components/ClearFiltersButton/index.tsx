...
import HandSparkles from '@components/Icons/HandSparkles'

// Hooks
import useClearFiltersButton from './useClearFiltersButton'
...
export default function ClearFiltersButton() {
  const { clear, disabled } = useClearFiltersButton()
