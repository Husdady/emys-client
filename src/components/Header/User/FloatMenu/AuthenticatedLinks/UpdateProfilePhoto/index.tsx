...
export default function UpdateProfilePhoto(props: MenuData) {
  ...
  return (
    <Button
      ...
      className="w-full navigation-list-item-link flex !flex-nowrap items-center !justify-start border-l-[5px] border-transparent py-3.5 sm:py-3 !px-3 sm:!px-3.5 font-semibold tracking-wide md:hover:bg-main-700/10 md:hover:text-main-700 dark:!font-normal dark:md:hover:!font-normal dark:md:hover:bg-pink-300/30 dark:md:hover:text-pink-200 whitespace-normal bg-transparent"
    />
  )
}
