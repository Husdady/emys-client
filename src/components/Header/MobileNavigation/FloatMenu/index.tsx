  ...
  return (
    <div
      className={classnames([
        ...
        'float-menu sm:max-w-[970px] top-[60px] sm:top-[6rem] sm:rounded-xl sm:mx-[2rem] dark:sm:shadow-gray-700 fixed left-0 right-0 bg-white shadow-xl dark:bg-black border-b border-gray-200 dark:border-gray-600 sm:border-none'
      ])}
    >
      <MenuContent {...props} />
      <MenuBottom />
