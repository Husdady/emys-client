      ...
      <Link
        ...
        className={classnames([
          router.pathname === path
            ...
            : 'dark:text-gray-200',
          'navigation-list-item-link flex items-center gap-x-5 justify-between border-l-[5px] border-transparent py-4 pl-3 pr-3 font-semibold tracking-wide md:hover:bg-main-700/10 md:hover:text-main-700 dark:!font-normal dark:md:hover:!font-normal dark:md:hover:bg-main-200/30 dark:md:hover:text-pink-200'
        ])}
      >
