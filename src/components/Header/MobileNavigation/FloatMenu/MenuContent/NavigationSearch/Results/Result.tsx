  ...
  return (
    <li className="navigation-seeker-item">
      ...
      >
        ...
        <ChevronRight size="smaller" className="stroke-4 text-main-700 dark:text-pink-300" />
      </Link>
    </li>
  )
}
