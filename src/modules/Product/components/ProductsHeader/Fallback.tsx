export default function Fallback() {
  return (
    <div className="w-full products-header products-header-fallback flex items-center gap-x-3 gap-y-4 justify-between xl:pl-3.5 xl:pr-2 mb-2">
      <div className="main-title h-[2.857rem] w-[22.5rem] rounded-lg bg-white dark:bg-gray-800"></div>
